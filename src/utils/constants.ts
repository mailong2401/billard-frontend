...
export const TABLE_STATUS: Record<TableStatus, { label: string; color: string; bgColor: string }> = {
  available: { label: 'Trống', color: 'text-green-700', bgColor: 'bg-green-100' },
  occupied: { label: 'Đang chơi', color: 'text-red-700', bgColor: 'bg-red-100' },
  reserved: { label: 'Đã đặt', color: 'text-yellow-700', bgColor: 'bg-yellow-100' },
  maintenance: { label: 'Bảo trì', color: 'text-gray-700', bgColor: 'bg-gray-100' },
  cleaning: { label: 'Đang dọn', color: 'text-blue-700', bgColor: 'bg-blue-100' },
};

export const TABLE_TYPE: Record<TableType, { label: string; priceSuffix: string }> = {
...
export const BOOKING_STATUS: Record<BookingStatus, { label: string; color: string; bgColor: string }> = {
  ...
  checked_in: { label: 'Đã nhận bàn', color: 'text-purple-700', bgColor: 'bg-purple-100' },
